...
<style>
body{
background:url(images/trans.jpg) no-repeat center ;
...
<?php  
				...
				?>
<tr>
			<th><center><a href="transfer.php"><button class="btn btn-primary" style="width:350px; height:40px; margin-top:3px; margin-bottom:3px; margin-left:1px;">TRANSFER</button></center></th>
</tr>			
</tbody>
</table>
      </div>  
